            ...
            <div id={"page-content"} className={"relative z-20 w-full bg-[#0a0a0a] top-118.75 flex flex-col items-center justify-center"}>
                <div className={"w-full px-16 flex flex-col items-center"}>
                    <div className={"w-full py-32 max-w-375 grid grid-cols-1 gap-y-12"}>
                        ...
                        <NeighborhoodCard page={"/urban/neighborhoods/bricks"} image={"/app_data/resources/neighbourhoods/bricks/banner.png"} logo={"/app_data/resources/neighbourhoods/bricks/logo.JPEG"} title={"Bee Bricks"} description={"Mattoni con cavità per insetti impollinatori. Supportano biodiversità urbana e ecosistemi."}/>
